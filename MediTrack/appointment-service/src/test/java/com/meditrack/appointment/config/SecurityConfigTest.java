...
class SecurityConfigTest {
    ...
    void testFilterChain() throws Exception {
        ...
        when(httpSecurity
                .addFilterBefore(any(JwtFilter.class), any()))
                .thenReturn(httpSecurity);

        DefaultSecurityFilterChain mockChain =
        ...
        verify(httpSecurity).addFilterBefore(any(JwtFilter.class), any());
